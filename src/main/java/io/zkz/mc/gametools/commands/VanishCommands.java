...
import io.zkz.mc.gametools.reflection.RegisterCommands;
import io.zkz.mc.gametools.reflection.RegisterPermissions;
...
import static io.zkz.mc.gametools.util.GTMiniMessageKt.mm;
...
public class VanishCommands {
    ...
    @RegisterCommands
    private static void registerCommands(CommandRegistryConnector registry) {
